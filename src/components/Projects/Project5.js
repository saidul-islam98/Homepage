...
import './Hline.css';
import pjimg1 from '../../assets/images/projectimg/bestclass.jpg';
        ...
        <div className={classes.root}>
            <Grid container>
                ...
                <Grid item xs={10} sm={5} className={classes.desc}>
                    <h3 className={classes.title}>Find the Best Classifier</h3>
                    <p className={classes.porjectDesc}> 
                        An IBM MOOC project in which the target was to find the best 
                        classifier <br/>among four machine learning classifiers. The classifier that gives
                        the <br/>best accuracy and smallest loss ultimately wins the title of "The Best Classifier".
                    </p>
                    ...
                    <br/><br/>
                    <CustomButton variant="outlined" color="secondary" href="https://github.com/saidul-islam98/Find-the-Best-Classifier">
                        github repo
                    </CustomButton>
                </Grid>
                <Grid item xs={1} sm={1} className={classes.sideSpacer}>
...
//https://github.com/saidul-islam98/Find-the-Best-Classifier